...
import se.malmin.chart.labels.CrosshairLabelGenerator;
...
public class Crosshair implements Cloneable, PublicCloneable, Serializable {
     ...
     *
     * @see #setLabelGenerator(se.malmin.chart.labels.CrosshairLabelGenerator)
     */
     ...
     *
     * @see #setLabelAnchor(se.malmin.chart.ui.RectangleAnchor)
     */
