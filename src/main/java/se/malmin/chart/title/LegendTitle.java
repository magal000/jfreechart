...
import se.malmin.chart.LegendItemSource;
import se.malmin.chart.block.Arrangement;
import se.malmin.chart.block.Block;
import se.malmin.chart.block.BlockContainer;
import se.malmin.chart.block.BlockFrame;
import se.malmin.chart.block.BlockResult;
import se.malmin.chart.block.BorderArrangement;
import se.malmin.chart.block.CenterArrangement;
import se.malmin.chart.block.ColumnArrangement;
import se.malmin.chart.block.EntityBlockParams;
...
import se.malmin.chart.entity.TitleEntity;
import se.malmin.chart.event.TitleChangeEvent;
...
public class LegendTitle extends Title
     ...
     *
     * @return An {@link se.malmin.chart.block.EntityBlockResult} or
     *         {@code null}.
     */
    @Override
