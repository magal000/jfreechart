...
import se.malmin.chart.block.BlockParams;
import se.malmin.chart.block.EntityBlockResult;
...
import se.malmin.chart.entity.JFreeChartEntity;
import se.malmin.chart.event.ChartChangeEvent;
import se.malmin.chart.event.ChartChangeListener;
import se.malmin.chart.event.ChartProgressEvent;
import se.malmin.chart.event.ChartProgressListener;
...
import se.malmin.chart.event.TitleChangeListener;
 ...
 * {@link se.malmin.data.general.Dataset} (the plot in turn manages a
...
public class JFreeChart implements Drawable, TitleChangeListener,
     ...
     * {@link se.malmin.chart.ui.Align} class.
     *
