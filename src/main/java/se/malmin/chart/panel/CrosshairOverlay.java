...
public class CrosshairOverlay extends AbstractOverlay implements Overlay,
     ...
     *
     * @see #removeDomainCrosshair(se.malmin.chart.plot.Crosshair)
     * @see #addRangeCrosshair(se.malmin.chart.plot.Crosshair)
     */
     ...
     * @param crosshair  the crosshair ({@code null} not permitted).
     *
     * @see #addDomainCrosshair(se.malmin.chart.plot.Crosshair)
     */
