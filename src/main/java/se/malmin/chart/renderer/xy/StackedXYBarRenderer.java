 ...
 * {@link se.malmin.data.xy.IntervalXYDataset} and a
 * {@link se.malmin.data.xy.TableXYDataset}. For example, the
 * dataset class {@link se.malmin.data.xy.CategoryTableXYDataset}
