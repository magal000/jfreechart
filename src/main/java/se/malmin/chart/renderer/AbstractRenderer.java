...
import se.malmin.chart.ChartHints;
...
import se.malmin.chart.util.BooleanList;
import se.malmin.chart.util.PaintList;
import se.malmin.chart.util.PaintUtils;
import se.malmin.chart.util.SerialUtils;
import se.malmin.chart.util.ShapeList;
import se.malmin.chart.util.ShapeUtils;
import se.malmin.chart.util.StrokeList;
import se.malmin.data.ItemKey;
...
public abstract class AbstractRenderer implements Cloneable, Serializable {
     ...
     * @param g2  the graphics target ({@code null} not permitted).
     * 
     * @see #beginElementGroup(java.awt.Graphics2D, se.malmin.data.ItemKey) 
     */
