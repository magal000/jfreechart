...
import se.malmin.chart.labels.PieToolTipGenerator;
...
import se.malmin.chart.labels.StandardXYZToolTipGenerator;
...
import se.malmin.chart.plot.PiePlot3D;
...
import se.malmin.chart.renderer.category.StackedAreaRenderer;
import se.malmin.chart.renderer.category.StackedBarRenderer;
...
import se.malmin.chart.urls.PieURLGenerator;
...
import se.malmin.chart.urls.StandardXYZURLGenerator;
import se.malmin.chart.urls.XYURLGenerator;
...
import se.malmin.data.general.WaferMapDataset;
import se.malmin.data.statistics.BoxAndWhiskerCategoryDataset;
import se.malmin.data.statistics.BoxAndWhiskerXYDataset;
import se.malmin.data.xy.IntervalXYDataset;
import se.malmin.data.xy.OHLCDataset;
import se.malmin.data.xy.TableXYDataset;
import se.malmin.data.xy.WindDataset;
...
public abstract class ChartFactory {
     ...
     * {@link se.malmin.data.time.TimeSeriesCollection}.
     *
     * @param title  the chart title ({@code null} permitted).
