...
public class CyclicNumberAxis extends NumberAxis {
     ...
     * @param notify  notify?
     *
     * @see se.malmin.chart.axis.ValueAxis#setAutoRangeMinimumSize(double,
     *      boolean)
     */
    @Override
     ...
     *
     * @see se.malmin.chart.axis.ValueAxis#setFixedAutoRange(double)
     */
    @Override
     ...
     * @param notify notify?
     *
     * @see se.malmin.chart.axis.ValueAxis#setRange(Range, boolean, boolean)
     */
    @Override
