 ...
 * se.malmin.data.json.impl.* to avoid conflicts with any other version that
...
//    }
     ...
     * 
     * @see se.malmin.data.json.impl.JSONObject#writeJSONString(Map, Writer)
     * @see se.malmin.data.json.impl.JSONArray#writeJSONString(List, Writer)
     * 
     ...
     * 
     * @see se.malmin.data.json.impl.JSONObject#toJSONString(Map)
     * @see se.malmin.data.json.impl.JSONArray#toJSONString(List)
     * 
     * @param value the value.
