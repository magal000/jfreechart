...
import se.malmin.data.general.AbstractSeriesDataset;
import se.malmin.data.general.SeriesChangeEvent;
import se.malmin.data.time.TimePeriod;
...
public class TaskSeriesCollection extends AbstractSeriesDataset
     ...
     * {@link se.malmin.data.general.DatasetChangeEvent} to all registered
     * listeners.
     *
     ...
     * a {@link se.malmin.data.general.DatasetChangeEvent}
