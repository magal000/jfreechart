 ...
 * dataset.
 *
 * @see se.malmin.data.xy.MatrixSeries
 */
public class MatrixSeriesCollection extends AbstractXYZDataset
     ...
     *
     * @see se.malmin.data.xy.XYDataset#getXValue(int, int)
     */
    @Override
     ...
     *
     * @see se.malmin.data.xy.XYDataset#getYValue(int, int)
     */
    @Override
     ...
     *
     * @see se.malmin.data.xy.XYZDataset#getZValue(int, int)
     */
    @Override
