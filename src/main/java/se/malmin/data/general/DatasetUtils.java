...
import se.malmin.data.xy.XYDomainInfo;
import se.malmin.data.xy.XYRangeInfo;
...
public final class DatasetUtils {
     ...
     * 
     * @see #findYValue(se.malmin.data.xy.XYDataset, int, double) 
     */
